...
export function initText(officerRole: string, applicantRole: string, appsChannel: string, applicantsCategory: string) {
    return "Run any of the following commands to override the defaults for app-bot. (Everything is case-insensitive)" +
        "\n\n" +
        "Current Settings:" +
        "```\n" +
...
export function appResponse(applicant: Applicant) {
    return "<@" +
        applicant.memberID +
        ">\n\n" +
